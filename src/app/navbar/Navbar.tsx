...
const NavbarSideLinks = `${myFontBold.className} btn btn-ghost px-4 text-lg tracking-widest pt-10 rounded-sm hover:pt-3 hover:bg-[#fbf9f9] duration-500 ease-in-out`;
